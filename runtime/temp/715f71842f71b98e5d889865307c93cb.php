<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"C:\WWW\tp5\public/../application/news\view\index\index.html";i:1521430949;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
            ...
            <link href="/tp5/public/static/css/css.css" rel="stylesheet" type="text/css">
                <script src="/tp5/public/static/js/js.js" type="text/javascript">
                </script>
            </link>
    ...
    <body>
                ...
                <div class="da-a-1">
                    ...
                    <div class="da-a-1-2">
                        <a href="<?php echo url('Index/index'); ?>" id="dd">
                            <img class="img" src="/tp5/public/static/img/listico.png"/>
                            返回新闻主页
                        </a>
                    </div>
                </div>
                <div class="da-a-2">
                    <img src="/tp5/public/static/img/logo.png" class="img2">
                    </img>
                </div>
            </div>
            <div class="da-b">
                <a href="<?php echo url('Index/add'); ?>">
                    <img class="img4" src="/tp5/public/static/img/icon05.png"/>
                </a>
                <font id="de">
                    添加新闻
                </font>
                <a href="<?php echo url('Index/index'); ?>">
                    <img class="img3" src="/tp5/public/static/img/home.png"/>
                </a>
                <font id="de">
                    主页
                </font>
                <a href="<?php echo url('Login/login'); ?>">
                    <img class="img3" src="/tp5/public/static/img/exit.png"/>
                </a>
                <font id="de">
                    退出
                </font>
        ...
        <div class="dc">
            ...
            Copyright©1999-2018, ctrip.com. All rights reserved. |
                ICP证：沪B2-20050130
            <br/>
            <img class="img5" src="/tp5/public/static/img/1.png"/>
            沪公网备31010502002731号
        </div>
    </body>
