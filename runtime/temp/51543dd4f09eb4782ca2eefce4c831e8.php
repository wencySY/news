<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"H:\wamp\www\news\public/../application/news\view\index\show.html";i:1521429324;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>
    ...
    <div class="show">
        ...
        <div id="img">
            ...
            <img src="/news/public/static/uploads/<?php echo $vol; ?>">
        ...
        <div id="go_top">
            <img alt="" class="img5" src="/news/public/static/img/5.png">
                <b>
                    回到顶部
                </b>
            </img>
    ...
    <script src="/news/public/static/js/jquery-1.4.2.min.js" type="text/javascript">
    </script>
